...
public class Launcher {
	...
	private static void restart(List<Tuple<String, String>> neededEnvironment, String pluginName) {
		try {
	...
	private static PluginLoader getPluginLoader(PluginDescription desc) {
		try {
