...
public final class INIFile
{
	...
	private final LinkedHashMap mhmapSections;

	/** Variable to hold environment variables **/
	private final Properties mpropEnv;
	 ...
	 */
	public INIFile(final String pstrPathAndName)
	{
...
------------------------------------------------------------------------------*/
	 ...
	 */
	public String getStringProperty(final String pstrSection, final String pstrProp)
	{
		String      strRet   = null;
	 ...
	 */
	public Boolean getBooleanProperty(final String pstrSection, final String pstrProp)
	{
	 ...
	 */
	public Integer getIntegerProperty(final String pstrSection, final String pstrProp)
	{
		Integer     intRet  = null;
		String      strVal  = null;
		INIProperty objProp = null;
	 ...
	 */
	public Long getLongProperty(final String pstrSection, final String pstrProp)
	{
		Long        lngRet  = null;
		String      strVal  = null;
		INIProperty objProp = null;
	 ...
	 */
	public Double getDoubleProperty(final String pstrSection, final String pstrProp)
	{
		Double      dblRet  = null;
		String      strVal  = null;
		INIProperty objProp = null;
	 ...
	 */
	public Date getDateProperty(final String pstrSection, final String pstrProp)
	{
		Date        dtRet   = null;
		String      strVal  = null;
	 ...
	 * @return the date property value.
	 */
	public Date getTimestampProperty(final String pstrSection, final String pstrProp)
	{
...
------------------------------------------------------------------------------*/
	 ...
	 */
	public void addSection(final String pstrSection, final String pstrComments)
	{
		INISection objSec   = null;
	 ...
	 */
	public void setStringProperty(final String pstrSection, final String pstrProp,
			final String pstrVal, final String pstrComments)
	{
		INISection objSec   = null;
	 ...
	 */
	public void setBooleanProperty(final String pstrSection, final String pstrProp,
			final boolean pblnVal, final String pstrComments)
	{
		INISection objSec   = null;
	 ...
	 */
	public void setIntegerProperty(final String pstrSection, final String pstrProp,
			final int pintVal, final String pstrComments)
	{
		INISection objSec   = null;
	 ...
	 */
	public void setLongProperty(final String pstrSection, final String pstrProp,
			final long plngVal, final String pstrComments)
	{
		INISection objSec   = null;
	 ...
	 */
	public void setDoubleProperty(final String pstrSection, final String pstrProp,
			final double pdblVal, final String pstrComments)
	{
		INISection objSec   = null;
	 ...
	 */
	public void setDateProperty(final String pstrSection, final String pstrProp,
			final Date pdtVal, final String pstrComments)
	{
		INISection objSec   = null;
	 ...
	 */
	public void setTimestampProperty(final String pstrSection, final String pstrProp,
			final Timestamp ptsVal, final String pstrComments)
	{
		INISection objSec   = null;
	 ...
	 */
	public void setDateFormat(final String pstrDtFmt) throws IllegalArgumentException
	{
	 ...
	 * @throws IllegalArgumentException if the if the given pattern is invalid
	 */
	public void setTimeStampFormat(final String pstrTSFmt)
	{
...
------------------------------------------------------------------------------*/
	 ...
	 */
	public String[] getPropertyNames(final String pstrSection)
	{
		String[]   arrRet = null;
		INISection objSec = null;
	 ...
	 */
	public Map getProperties(final String pstrSection)
	{
		Map        hmRet = null;
		INISection objSec = null;
	 ...
	 */
	public void removeProperty(final String pstrSection, final String pstrProp)
	{
		INISection objSec = null;
	 ...
	 */
	public void removeSection(final String pstrSection)
	{
	 ...
	 */
	private boolean checkDateTimeFormat(final String pstrDtFmt)
	{
		boolean    blnRet = false;
	 ...
	 */
	private void closeReader(final Reader pobjRdr)
	{
	 ...
	 */
	private void closeWriter(final Writer pobjWriter)
	{
	 ...
	 */
	private boolean checkFile(final String pstrFile)
	{
		boolean blnRet  = false;
		File    objFile = null;
	 ...
	 * @return String
	 */
	private String utilDateToStr(final Date pdt, final String pstrFmt)
	{
		String strRet = null;
	 ...
	 */
	private String timeToStr(final Timestamp pobjTS, final String pstrFmt)
	{
		String strRet = null;
		SimpleDateFormat dtFmt = null;
	...
	private String addRemChars(String pstrSrc)
	{
		...
		if (!pstrSrc.isEmpty() && !pstrSrc.substring(0, 1).equals(";"))
			pstrSrc = ";" + pstrSrc;
		pstrSrc = pstrSrc + "\r\n";
		return pstrSrc;
	}
	...
	private class INISection
	{
		...
		private final LinkedHashMap mhmapProps;
		 ...
		 */
		public INISection(final String pstrSection)
		{
		 ...
		 */
		public INISection(final String pstrSection, final String pstrComments)
		{
			this.mstrName =  pstrSection;
		 ...
		 * @param pstrComments the comments
		 */
		public void setSecComments(final String pstrComments)
		{
			this.mstrComment = delRemChars(pstrComments);
		}
		 ...
		 */
		public void setSecName(final String pstrName)
		{
		 ...
		 * @param pstrProp The name of the property to be removed.
		 */
		public void removeProperty(final String pstrProp)
		{
		 ...
		 */
		public void setProperty(final String pstrProp, final String pstrValue, final String pstrComments)
		{
		 ...
		 */
		public INIProperty getProperty(final String pstrProp)
		{
	...
	private class INIProperty
	{
		 ...
		 */
		public INIProperty(final String pstrName, final String pstrValue)
		{
			this.mstrName = pstrName;
		 ...
		 */
		public INIProperty(final String pstrName, final String pstrValue, final String pstrComments)
		{
			this.mstrName = pstrName;
			this.mstrValue = pstrValue;
		 ...
		 */
		public void setPropName(final String pstrName)
		{
			this.mstrName = pstrName;
		}
		 ...
		 */
		public void setPropValue(final String pstrValue)
		{
			this.mstrValue = pstrValue;
		}
		 ...
		 * @param pstrComments the comments
		 */
		public void setPropComments(final String pstrComments)
		{
			this.mstrComments = delRemChars(pstrComments);
		}
